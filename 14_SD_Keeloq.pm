######################################################################################################################
# $Id: 14_SD_Keeloq.pm 32 2019-02-21 12:00:00Z v3.4-dev_02.12. $
#
...
<a name="SD_Keeloq"></a>
<h3>SD_Keeloq</h3>
<ul>The module SD_Keeloq is a <br>

	<b>Define</b><br>
	<ul><code>define &lt;NAME&gt; SD_Keeloq &lt;Device-ID&gt;</code><br><br>
	<u>examples:</u>
		<ul>
		define &lt;NAME&gt; SD_Keeloq 12345678<br>
		</ul>	</ul><br><br>
...
<a name="SD_Keeloq"></a>
<h3>SD_Keeloq</h3>
<ul>Das SD_Keeloq Modul dient zur Verarbeitung von Geräten welche nach dem KeeLoqverfahren arbeiten. Es wurde nach Vorlage des Bastelbudenbuben Projektes gefertigt. 
	...
	Das angelegte Device wird mit der Seriennummer der Fernbedienung und dem Zustand des Gerätes teilweise dargestellt.<br><br>

	<b><i>Nach Eingabe der richtigen Schlüssel erhält man alle Zustände und das Senden bzw. steuern ist möglich!<br>
	Eine Verankerung der Schlüssel im Modul ist NICHT enthalten und jeder muss diese selbst verwalten.</i></b><br>
	...
	<br>
	<b><i>Jedes Model besitzt eine andere Länge der Seriennummer! Bitte geben Sie die Serialnummer hexadezimal ein.<br>
	Bei den Modellen Roto & Waeco_MA650_TX ist die Länge jeweils 7 und bei dem Model JaroLift 6.</i></b>
	<br><br><br>

	<b>Define</b><br>
	<ul><code>define &lt;NAME&gt; SD_Keeloq &lt;Serial&gt; </code><br><br>
	Beispiele: <ul><li>define SD_Keeloq_Device1 SD_Keeloq 9AF000</li>
	...
	Beispiele: <ul>set SD_Keeloq_9AF000 down 7<br>
	set SD_Keeloq_9AF000 down Nordseite</ul>
	</ul><br><br>
	...
	<b>Attribute</b><br><br>
	<ul>
		<u><b>NUR für das Modell JaroLift!</b></u>
